...
export interface User {
  ...
  role: 'admin' | 'marketer';
  /**
   * Маркетолог бачить лендинги тільки обраних субдоменів
   */
...
export interface LandingPage {
  ...
  title: string;
  /**
   * Тільки латиниця, дефіси. Наприклад: spring-sale
   */
  slug: string;
  ...
  blocks?:
    | (
        | {
            ...
            layout?: ('imageRight' | 'imageLeft' | 'centered' | 'backgroundImage') | null;
            theme?: ('light' | 'dark' | 'colored') | null;
            /**
             * Залиш порожнім якщо A/B тест не потрібен
             */
            abTest?: {
              experimentKey?: string | null;
              variantB?: {
